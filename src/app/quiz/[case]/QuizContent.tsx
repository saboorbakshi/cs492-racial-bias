...
export default function QuizContent({ caseParam }: { caseParam: string }) {
                    ...
                    <div className="space-y-2">
                      {question.options?.map((option, optionIndex) => {
                        ...
                        return (
                          <div
                            key={optionIndex}
                            className={`p-3 rounded-md ${bgColor} ${isSelected ? 'border-2 border-blue-300' : 'border border-gray-200'
                              }`}
                          >
